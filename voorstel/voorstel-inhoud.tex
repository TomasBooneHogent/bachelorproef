...
Met de opkomst van 'FinTech' verschuift de focus van statische analyse naar dynamische Big Data-toepassingen. Cloud-native datawarehouses, zoals Google BigQuery, zijn superieur in het verwerken van datasets van miljoenen rijen ten opzichte van traditionele servers \parencite{Kaur2022}. De keuze voor BigQuery in dit onderzoek wordt gemotiveerd door de serverless architectuur, de lage kosten, performantie en ervaring \parencite{GoogleCloud2024}.
