...
\begin{enumerate}
    \item Op welke manier kan een dataset, gebaseerd op publiek beschikbare NBB-data, worden opgezet zodat deze optimaal bruikbaar is voor verdere data-analyse?
    \item Hoe kan een zinvolle segmentatie of clustering van ondernemingen worden gerealiseerd, en geniet een functionele dan wel een datagedreven (technische) clustering de voorkeur?
    \item In welke mate zijn machine learning-modellen, getraind op deze publieke NBB-data, geschikt om toekomstige bedrijfsprestaties te voorspellen op basis van historische financiële ratio's?
    \item Welke impact heeft de implementatie van een dergelijk Big Data-platform en de bijhorende predictieve modellen op de werkwijze en kredietbeoordeling van de financiële analist?
\end{enumerate}
...
Vervolgens documenteert Hoofdstuk~\ref{ch:architectuur} de technische architectuur, de inrichting van het cloud-datawarehouse en de werking van de ETL-pijplijn. Hoofdstuk~\ref{ch:resultaten} evalueert daarna de verzamelde resultaten, met bijzondere aandacht voor de exploratieve sectoranalyse en de accuraatheid van de predictieve machine learning-modellen. In Hoofdstuk~\ref{ch:conclusie}, ten slotte, geeft het onderzoek een sluitend antwoord op de onderzoeksvragen, bediscussieert het de relevantie van de bevindingen voor de financiële sector en reikt het suggesties aan voor vervolgonderzoek.