...
De huidige werkwijze voor financiële risicoanalyse is overwegend reactief. Door sterk te focussen op individuele, historische jaarrekeningen, isoleert het proces de onderneming van haar bredere sectorale context. Een bedrijf presteert immers nooit in een vacuüm; de prestaties hangen nauw samen met sectorbrede economische verschuivingen. Het handmatig vergelijken van de cijfers van een onderneming met al haar sectorgenoten vormt echter een enorm arbeidsintensief proces, zeker zonder de juiste technologische ondersteuning. Bijgevolg blijven sectorbrede trends en vroegtijdige waarschuwingssignalen voor wanbetaling vaak over het hoofd gezien, wat resulteert in een suboptimale risico-inschatting en potentieel financiële verliezen voor de kredietverstrekker.
...
\begin{enumerate}
    \item Welke technieken en architectuurpatronen zijn optimaal voor het structureel extraheren, transformeren en laden (ETL) van de NBB-dataset?
    ...
    \item Welke impact heeft het implementeren van een Big Data-platform op de werkwijze van de financiële analist?
\end{enumerate}
...
% TODO: Voeg hier een korte beschrijving toe van je resterende hoofdstukken (bijv. resultaten) zodra je deze uitschrijft. Voorbeeld:
% In Hoofdstuk 4 wordt de opbouw van de architectuur en de ETL-pijplijn gedocumenteerd, waarna Hoofdstuk 5 de resultaten van de machine learning modellen toelicht.

In Hoofdstuk~\ref{ch:conclusie}, tenslotte, geeft het onderzoek een antwoord op de onderzoeksvragen, bediscussieert het de relevantie van de bevindingen voor het werkveld en reikt het suggesties aan voor verder onderzoek.